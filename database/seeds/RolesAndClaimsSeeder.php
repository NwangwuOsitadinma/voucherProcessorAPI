...
class RolesAndClaimsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Bouncer::seeder(function() use ($user) {
            ...
            'create-voucher', 'view-all-vouchers', 'view-vouchers', 'edit-voucher', 'delete-voucher', 'approve-voucher', 'pay-voucher', 'create-item', 'view-items', 'edit-items', 'delete-items', 'delete-user']);
            ...
            'create-voucher', 'view-all-vouchers', 'view-vouchers', 'edit-voucher', 'delete-voucher', 'approve-voucher', 'create-item', 'view-items', 'edit-items', 'delete-items']);
